...
/**
 * The Producer class will put things into the buffer. To simulate randomness of the threads, the example has placed sleep commands on the thread object
 */
public class Producer implements Runnable {
    ...
    /**
     * thread code that will run the simulation
     */
    public void run() {
        int sum = 0;
